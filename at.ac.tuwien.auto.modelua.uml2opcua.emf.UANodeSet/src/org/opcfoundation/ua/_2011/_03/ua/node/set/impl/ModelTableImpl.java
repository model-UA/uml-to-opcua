 ...
 * </p>
 * <ul>
 *   <li>{@link org.opcfoundation.ua._2011._03.ua.node.set.impl.ModelTableImpl#getModel <em>Model</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelTableImpl extends MinimalEObjectImpl.Container implements ModelTable {
	...
	protected EClass eStaticClass() {
		return SetPackage.Literals.MODEL_TABLE;
	}
	...
	public EList<ModelTableEntry> getModel() {
		if (model == null) {
			model = new EObjectContainmentEList<ModelTableEntry>(ModelTableEntry.class, this, SetPackage.MODEL_TABLE__MODEL);
		}
		return model;
	}
