...
/**
 * This is the item provider adapter for a {@link org.opcfoundation.ua._2008._02.types.Argument} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArgumentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TypesPackage.eINSTANCE.getArgument_Name(),
				 true,
				 false,
				 false,
	...
	protected void addValueRankPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Argument_valueRank_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Argument_valueRank_feature", "_UI_Argument_type"),
				 TypesPackage.eINSTANCE.getArgument_ValueRank(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TypesPackage.eINSTANCE.getArgument_DataType());
			childrenFeatures.add(TypesPackage.eINSTANCE.getArgument_ArrayDimensions());
			childrenFeatures.add(TypesPackage.eINSTANCE.getArgument_Description());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.eINSTANCE.getArgument_DataType(),
				 TypesFactory.eINSTANCE.createNodeId()));

		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.eINSTANCE.getArgument_ArrayDimensions(),
				 TypesFactory.eINSTANCE.createListOfUInt32()));

		newChildDescriptors.add
			(createChildParameter
				(TypesPackage.eINSTANCE.getArgument_Description(),
