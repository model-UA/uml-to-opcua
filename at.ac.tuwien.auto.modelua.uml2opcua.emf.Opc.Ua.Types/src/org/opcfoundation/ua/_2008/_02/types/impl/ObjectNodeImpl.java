 ...
 * </p>
 * <ul>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.ObjectNodeImpl#getEventNotifier <em>Event Notifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectNodeImpl extends InstanceNodeImpl implements ObjectNode {
	/**
	...
	protected EClass eStaticClass() {
		return TypesPackage.eINSTANCE.getObjectNode();
	}
	...
	public void setEventNotifier(short newEventNotifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.OBJECT_NODE__EVENT_NOTIFIER, oldEventNotifier, eventNotifier, !oldEventNotifierESet));
	}
	...
	public void unsetEventNotifier() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.OBJECT_NODE__EVENT_NOTIFIER, oldEventNotifier, EVENT_NOTIFIER_EDEFAULT, oldEventNotifierESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypesPackage.OBJECT_NODE__EVENT_NOTIFIER:
