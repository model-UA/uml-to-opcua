...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Set Publishing Mode Request</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.SetPublishingModeRequestImpl#getRequestHeader <em>Request Header</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.SetPublishingModeRequestImpl#isPublishingEnabled <em>Publishing Enabled</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.SetPublishingModeRequestImpl#getSubscriptionIds <em>Subscription Ids</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetPublishingModeRequestImpl extends MinimalEObjectImpl.Container implements SetPublishingModeRequest {
	/**
	 ...
	 * @generated
	 */
	protected SetPublishingModeRequestImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TypesPackage.eINSTANCE.getSetPublishingModeRequest();
	}
	...
	public NotificationChain basicSetRequestHeader(RequestHeader newRequestHeader, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.SET_PUBLISHING_MODE_REQUEST__REQUEST_HEADER, oldRequestHeader, newRequestHeader, !oldRequestHeaderESet);
	...
	public void setRequestHeader(RequestHeader newRequestHeader) {
		if (newRequestHeader != requestHeader) {
			...
			if (requestHeader != null)
				msgs = ((InternalEObject)requestHeader).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.SET_PUBLISHING_MODE_REQUEST__REQUEST_HEADER, null, msgs);
			if (newRequestHeader != null)
				msgs = ((InternalEObject)newRequestHeader).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.SET_PUBLISHING_MODE_REQUEST__REQUEST_HEADER, null, msgs);
			...
			requestHeaderESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.SET_PUBLISHING_MODE_REQUEST__REQUEST_HEADER, newRequestHeader, newRequestHeader, !oldRequestHeaderESet));
		}
	}
	...
	public NotificationChain basicUnsetRequestHeader(NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, TypesPackage.SET_PUBLISHING_MODE_REQUEST__REQUEST_HEADER, oldRequestHeader, null, oldRequestHeaderESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void unsetRequestHeader() {
		if (requestHeader != null) {
			...
			requestHeaderESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.SET_PUBLISHING_MODE_REQUEST__REQUEST_HEADER, null, null, oldRequestHeaderESet));
		}
	}
	...
	public void setPublishingEnabled(boolean newPublishingEnabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.SET_PUBLISHING_MODE_REQUEST__PUBLISHING_ENABLED, oldPublishingEnabled, publishingEnabled, !oldPublishingEnabledESet));
	}
	...
	public void unsetPublishingEnabled() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.SET_PUBLISHING_MODE_REQUEST__PUBLISHING_ENABLED, oldPublishingEnabled, PUBLISHING_ENABLED_EDEFAULT, oldPublishingEnabledESet));
	}
	...
	public NotificationChain basicSetSubscriptionIds(ListOfUInt32 newSubscriptionIds, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.SET_PUBLISHING_MODE_REQUEST__SUBSCRIPTION_IDS, oldSubscriptionIds, newSubscriptionIds, !oldSubscriptionIdsESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSubscriptionIds(ListOfUInt32 newSubscriptionIds) {
		if (newSubscriptionIds != subscriptionIds) {
			...
			if (subscriptionIds != null)
				msgs = ((InternalEObject)subscriptionIds).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.SET_PUBLISHING_MODE_REQUEST__SUBSCRIPTION_IDS, null, msgs);
			if (newSubscriptionIds != null)
				msgs = ((InternalEObject)newSubscriptionIds).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.SET_PUBLISHING_MODE_REQUEST__SUBSCRIPTION_IDS, null, msgs);
			...
			subscriptionIdsESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.SET_PUBLISHING_MODE_REQUEST__SUBSCRIPTION_IDS, newSubscriptionIds, newSubscriptionIds, !oldSubscriptionIdsESet));
		}
	}
	...
	public NotificationChain basicUnsetSubscriptionIds(NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, TypesPackage.SET_PUBLISHING_MODE_REQUEST__SUBSCRIPTION_IDS, oldSubscriptionIds, null, oldSubscriptionIdsESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void unsetSubscriptionIds() {
		if (subscriptionIds != null) {
			...
			subscriptionIdsESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.SET_PUBLISHING_MODE_REQUEST__SUBSCRIPTION_IDS, null, null, oldSubscriptionIdsESet));
		}
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TypesPackage.SET_PUBLISHING_MODE_REQUEST__REQUEST_HEADER:
				return basicUnsetRequestHeader(msgs);
			case TypesPackage.SET_PUBLISHING_MODE_REQUEST__SUBSCRIPTION_IDS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TypesPackage.SET_PUBLISHING_MODE_REQUEST__PUBLISHING_ENABLED:
