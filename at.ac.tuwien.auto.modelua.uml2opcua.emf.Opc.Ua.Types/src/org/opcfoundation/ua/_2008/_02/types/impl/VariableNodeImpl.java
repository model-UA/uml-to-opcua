 ...
 * </p>
 * <ul>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.VariableNodeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.VariableNodeImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.VariableNodeImpl#getValueRank <em>Value Rank</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.VariableNodeImpl#getArrayDimensions <em>Array Dimensions</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.VariableNodeImpl#getAccessLevel <em>Access Level</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.VariableNodeImpl#getUserAccessLevel <em>User Access Level</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.VariableNodeImpl#getMinimumSamplingInterval <em>Minimum Sampling Interval</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.VariableNodeImpl#isHistorizing <em>Historizing</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.VariableNodeImpl#getAccessLevelEx <em>Access Level Ex</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableNodeImpl extends InstanceNodeImpl implements VariableNode {
	/**
	...
	/**
	 * The default value of the '{@link #getAccessLevelEx() <em>Access Level Ex</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final long ACCESS_LEVEL_EX_EDEFAULT = 0L;

	/**
	 * The cached value of the '{@link #getAccessLevelEx() <em>Access Level Ex</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAccessLevelEx()
	 * @generated
	 * @ordered
	 */
	protected long accessLevelEx = ACCESS_LEVEL_EX_EDEFAULT;

	/**
	 * This is true if the Access Level Ex attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	protected boolean accessLevelExESet;
	...
	protected EClass eStaticClass() {
		return TypesPackage.eINSTANCE.getVariableNode();
	}
	...
	public NotificationChain basicSetValue(Variant newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__VALUE, oldValue, newValue);
	...
	public void setValue(Variant newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.VARIABLE_NODE__VALUE, null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.VARIABLE_NODE__VALUE, null, msgs);
			msgs = basicSetValue(newValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__VALUE, newValue, newValue));
	}
	...
	public NotificationChain basicSetDataType(NodeId newDataType, NotificationChain msgs) {
		...
		dataTypeESet = true;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__DATA_TYPE, oldDataType, newDataType, !oldDataTypeESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDataType(NodeId newDataType) {
		if (newDataType != dataType) {
			NotificationChain msgs = null;
			if (dataType != null)
				msgs = ((InternalEObject)dataType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.VARIABLE_NODE__DATA_TYPE, null, msgs);
			if (newDataType != null)
				msgs = ((InternalEObject)newDataType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.VARIABLE_NODE__DATA_TYPE, null, msgs);
			...
			dataTypeESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__DATA_TYPE, newDataType, newDataType, !oldDataTypeESet));
		}
	}
	...
	public NotificationChain basicUnsetDataType(NotificationChain msgs) {
		...
		dataTypeESet = false;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, TypesPackage.VARIABLE_NODE__DATA_TYPE, oldDataType, null, oldDataTypeESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void unsetDataType() {
		if (dataType != null) {
			...
			dataTypeESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.VARIABLE_NODE__DATA_TYPE, null, null, oldDataTypeESet));
		}
	}
	...
	public void setValueRank(int newValueRank) {
		...
		valueRankESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__VALUE_RANK, oldValueRank, valueRank, !oldValueRankESet));
	}
	...
	public void unsetValueRank() {
		...
		valueRankESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.VARIABLE_NODE__VALUE_RANK, oldValueRank, VALUE_RANK_EDEFAULT, oldValueRankESet));
	}
	...
	public NotificationChain basicSetArrayDimensions(ListOfUInt32 newArrayDimensions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__ARRAY_DIMENSIONS, oldArrayDimensions, newArrayDimensions, !oldArrayDimensionsESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setArrayDimensions(ListOfUInt32 newArrayDimensions) {
		if (newArrayDimensions != arrayDimensions) {
			...
			if (arrayDimensions != null)
				msgs = ((InternalEObject)arrayDimensions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.VARIABLE_NODE__ARRAY_DIMENSIONS, null, msgs);
			if (newArrayDimensions != null)
				msgs = ((InternalEObject)newArrayDimensions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.VARIABLE_NODE__ARRAY_DIMENSIONS, null, msgs);
			...
			arrayDimensionsESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__ARRAY_DIMENSIONS, newArrayDimensions, newArrayDimensions, !oldArrayDimensionsESet));
		}
	}
	...
	public NotificationChain basicUnsetArrayDimensions(NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, TypesPackage.VARIABLE_NODE__ARRAY_DIMENSIONS, oldArrayDimensions, null, oldArrayDimensionsESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void unsetArrayDimensions() {
		if (arrayDimensions != null) {
			...
			arrayDimensionsESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.VARIABLE_NODE__ARRAY_DIMENSIONS, null, null, oldArrayDimensionsESet));
		}
	}
	...
	public void setAccessLevel(short newAccessLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__ACCESS_LEVEL, oldAccessLevel, accessLevel, !oldAccessLevelESet));
	}
	...
	public void unsetAccessLevel() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.VARIABLE_NODE__ACCESS_LEVEL, oldAccessLevel, ACCESS_LEVEL_EDEFAULT, oldAccessLevelESet));
	}
	...
	public void setUserAccessLevel(short newUserAccessLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__USER_ACCESS_LEVEL, oldUserAccessLevel, userAccessLevel, !oldUserAccessLevelESet));
	}
	...
	public void unsetUserAccessLevel() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.VARIABLE_NODE__USER_ACCESS_LEVEL, oldUserAccessLevel, USER_ACCESS_LEVEL_EDEFAULT, oldUserAccessLevelESet));
	}
	...
	public void setMinimumSamplingInterval(double newMinimumSamplingInterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__MINIMUM_SAMPLING_INTERVAL, oldMinimumSamplingInterval, minimumSamplingInterval, !oldMinimumSamplingIntervalESet));
	}
	...
	public void unsetMinimumSamplingInterval() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.VARIABLE_NODE__MINIMUM_SAMPLING_INTERVAL, oldMinimumSamplingInterval, MINIMUM_SAMPLING_INTERVAL_EDEFAULT, oldMinimumSamplingIntervalESet));
	}
	...
	public void setHistorizing(boolean newHistorizing) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__HISTORIZING, oldHistorizing, historizing, !oldHistorizingESet));
	}
	...
	public void unsetHistorizing() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.VARIABLE_NODE__HISTORIZING, oldHistorizing, HISTORIZING_EDEFAULT, oldHistorizingESet));
	}
	 ...
	 * @generated
	 */
	public void setAccessLevelEx(long newAccessLevelEx) {
		long oldAccessLevelEx = accessLevelEx;
		accessLevelEx = newAccessLevelEx;
		boolean oldAccessLevelExESet = accessLevelExESet;
		accessLevelExESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.VARIABLE_NODE__ACCESS_LEVEL_EX, oldAccessLevelEx, accessLevelEx, !oldAccessLevelExESet));
	}
	 ...
	 * @generated
	 */
	public void unsetAccessLevelEx() {
		long oldAccessLevelEx = accessLevelEx;
		boolean oldAccessLevelExESet = accessLevelExESet;
		accessLevelEx = ACCESS_LEVEL_EX_EDEFAULT;
		accessLevelExESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.VARIABLE_NODE__ACCESS_LEVEL_EX, oldAccessLevelEx, ACCESS_LEVEL_EX_EDEFAULT, oldAccessLevelExESet));
	}
	 ...
	 * @generated
	 */
	public boolean isSetAccessLevelEx() {
		return accessLevelExESet;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case TypesPackage.VARIABLE_NODE__HISTORIZING:
				...
				return;
			case TypesPackage.VARIABLE_NODE__ACCESS_LEVEL_EX:
				setAccessLevelEx((Long)newValue);
				return;
		}
	...
	public String toString() {
		...
		result.append(", accessLevelEx: ");
		if (accessLevelExESet) result.append(accessLevelEx); else result.append("<unset>");
		result.append(')');
