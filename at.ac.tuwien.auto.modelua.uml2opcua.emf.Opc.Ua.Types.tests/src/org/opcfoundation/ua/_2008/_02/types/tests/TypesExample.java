...
import org.opcfoundation.ua._2008._02.types.util.TypesResourceFactoryImpl;
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				...
				ActivateSessionRequest root = TypesFactory.eINSTANCE.createActivateSessionRequest();
				documentRoot.setActivateSessionRequest(root);
