...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>UA View</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.opcfoundation.ua._2011._03.ua.node.set.impl.UAViewImpl#isContainsNoLoops <em>Contains No Loops</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2011._03.ua.node.set.impl.UAViewImpl#getEventNotifier <em>Event Notifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UAViewImpl extends UAInstanceImpl implements UAView {
	/**
	...
	protected EClass eStaticClass() {
		return SetPackage.Literals.UA_VIEW;
	}
	...
	public void setContainsNoLoops(boolean newContainsNoLoops) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SetPackage.UA_VIEW__CONTAINS_NO_LOOPS, oldContainsNoLoops, containsNoLoops, !oldContainsNoLoopsESet));
	}
	...
	public void unsetContainsNoLoops() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SetPackage.UA_VIEW__CONTAINS_NO_LOOPS, oldContainsNoLoops, CONTAINS_NO_LOOPS_EDEFAULT, oldContainsNoLoopsESet));
	}
	...
	public void setEventNotifier(short newEventNotifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SetPackage.UA_VIEW__EVENT_NOTIFIER, oldEventNotifier, eventNotifier, !oldEventNotifierESet));
	}
	...
	public void unsetEventNotifier() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, SetPackage.UA_VIEW__EVENT_NOTIFIER, oldEventNotifier, EVENT_NOTIFIER_EDEFAULT, oldEventNotifierESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SetPackage.UA_VIEW__CONTAINS_NO_LOOPS:
				return isContainsNoLoops();
			case SetPackage.UA_VIEW__EVENT_NOTIFIER:
