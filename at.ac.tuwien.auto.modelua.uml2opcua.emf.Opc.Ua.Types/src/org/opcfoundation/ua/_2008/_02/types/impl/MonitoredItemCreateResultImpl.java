...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Monitored Item Create Result</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.MonitoredItemCreateResultImpl#getStatusCode <em>Status Code</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.MonitoredItemCreateResultImpl#getMonitoredItemId <em>Monitored Item Id</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.MonitoredItemCreateResultImpl#getRevisedSamplingInterval <em>Revised Sampling Interval</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.MonitoredItemCreateResultImpl#getRevisedQueueSize <em>Revised Queue Size</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.MonitoredItemCreateResultImpl#getFilterResult <em>Filter Result</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MonitoredItemCreateResultImpl extends MinimalEObjectImpl.Container implements MonitoredItemCreateResult {
	/**
	 ...
	 * @generated
	 */
	protected MonitoredItemCreateResultImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TypesPackage.eINSTANCE.getMonitoredItemCreateResult();
	}
	...
	public NotificationChain basicSetStatusCode(StatusCode newStatusCode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__STATUS_CODE, oldStatusCode, newStatusCode);
	...
	public void setStatusCode(StatusCode newStatusCode) {
		if (newStatusCode != statusCode) {
			...
			if (statusCode != null)
				msgs = ((InternalEObject)statusCode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.MONITORED_ITEM_CREATE_RESULT__STATUS_CODE, null, msgs);
			if (newStatusCode != null)
				msgs = ((InternalEObject)newStatusCode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.MONITORED_ITEM_CREATE_RESULT__STATUS_CODE, null, msgs);
			msgs = basicSetStatusCode(newStatusCode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__STATUS_CODE, newStatusCode, newStatusCode));
	}
	...
	public void setMonitoredItemId(long newMonitoredItemId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__MONITORED_ITEM_ID, oldMonitoredItemId, monitoredItemId, !oldMonitoredItemIdESet));
	}
	...
	public void unsetMonitoredItemId() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__MONITORED_ITEM_ID, oldMonitoredItemId, MONITORED_ITEM_ID_EDEFAULT, oldMonitoredItemIdESet));
	}
	...
	public void setRevisedSamplingInterval(double newRevisedSamplingInterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__REVISED_SAMPLING_INTERVAL, oldRevisedSamplingInterval, revisedSamplingInterval, !oldRevisedSamplingIntervalESet));
	}
	...
	public void unsetRevisedSamplingInterval() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__REVISED_SAMPLING_INTERVAL, oldRevisedSamplingInterval, REVISED_SAMPLING_INTERVAL_EDEFAULT, oldRevisedSamplingIntervalESet));
	}
	...
	public void setRevisedQueueSize(long newRevisedQueueSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__REVISED_QUEUE_SIZE, oldRevisedQueueSize, revisedQueueSize, !oldRevisedQueueSizeESet));
	}
	...
	public void unsetRevisedQueueSize() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__REVISED_QUEUE_SIZE, oldRevisedQueueSize, REVISED_QUEUE_SIZE_EDEFAULT, oldRevisedQueueSizeESet));
	}
	...
	public NotificationChain basicSetFilterResult(ExtensionObject newFilterResult, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__FILTER_RESULT, oldFilterResult, newFilterResult, !oldFilterResultESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFilterResult(ExtensionObject newFilterResult) {
		if (newFilterResult != filterResult) {
			...
			if (filterResult != null)
				msgs = ((InternalEObject)filterResult).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TypesPackage.MONITORED_ITEM_CREATE_RESULT__FILTER_RESULT, null, msgs);
			if (newFilterResult != null)
				msgs = ((InternalEObject)newFilterResult).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TypesPackage.MONITORED_ITEM_CREATE_RESULT__FILTER_RESULT, null, msgs);
			...
			filterResultESet = true;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__FILTER_RESULT, newFilterResult, newFilterResult, !oldFilterResultESet));
		}
	}
	...
	public NotificationChain basicUnsetFilterResult(NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.UNSET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__FILTER_RESULT, oldFilterResult, null, oldFilterResultESet);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void unsetFilterResult() {
		if (filterResult != null) {
			...
			filterResultESet = false;
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.MONITORED_ITEM_CREATE_RESULT__FILTER_RESULT, null, null, oldFilterResultESet));
		}
	}
