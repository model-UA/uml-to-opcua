 ...
 * </p>
 * <ul>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.ViewNodeImpl#isContainsNoLoops <em>Contains No Loops</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.ViewNodeImpl#getEventNotifier <em>Event Notifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewNodeImpl extends InstanceNodeImpl implements ViewNode {
	/**
	...
	protected EClass eStaticClass() {
		return TypesPackage.eINSTANCE.getViewNode();
	}
	...
	public void setContainsNoLoops(boolean newContainsNoLoops) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.VIEW_NODE__CONTAINS_NO_LOOPS, oldContainsNoLoops, containsNoLoops, !oldContainsNoLoopsESet));
	}
	...
	public void unsetContainsNoLoops() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.VIEW_NODE__CONTAINS_NO_LOOPS, oldContainsNoLoops, CONTAINS_NO_LOOPS_EDEFAULT, oldContainsNoLoopsESet));
	}
	...
	public void setEventNotifier(short newEventNotifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.VIEW_NODE__EVENT_NOTIFIER, oldEventNotifier, eventNotifier, !oldEventNotifierESet));
	}
	...
	public void unsetEventNotifier() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.VIEW_NODE__EVENT_NOTIFIER, oldEventNotifier, EVENT_NOTIFIER_EDEFAULT, oldEventNotifierESet));
	}
