...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Broker Data Set Writer Transport Data Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.BrokerDataSetWriterTransportDataTypeImpl#getQueueName <em>Queue Name</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.BrokerDataSetWriterTransportDataTypeImpl#getResourceUri <em>Resource Uri</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.BrokerDataSetWriterTransportDataTypeImpl#getAuthenticationProfileUri <em>Authentication Profile Uri</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.BrokerDataSetWriterTransportDataTypeImpl#getRequestedDeliveryGuarantee <em>Requested Delivery Guarantee</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.BrokerDataSetWriterTransportDataTypeImpl#getMetaDataQueueName <em>Meta Data Queue Name</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2008._02.types.impl.BrokerDataSetWriterTransportDataTypeImpl#getMetaDataUpdateTime <em>Meta Data Update Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BrokerDataSetWriterTransportDataTypeImpl extends DataSetWriterTransportDataTypeImpl implements BrokerDataSetWriterTransportDataType {
	/**
	...
	/**
	 * The default value of the '{@link #getMetaDataUpdateTime() <em>Meta Data Update Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final double META_DATA_UPDATE_TIME_EDEFAULT = 0.0;

	/**
	 * The cached value of the '{@link #getMetaDataUpdateTime() <em>Meta Data Update Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMetaDataUpdateTime()
	 * @generated
	 * @ordered
	 */
	protected double metaDataUpdateTime = META_DATA_UPDATE_TIME_EDEFAULT;

	/**
	 * This is true if the Meta Data Update Time attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	protected boolean metaDataUpdateTimeESet;
	 ...
	 * @generated
	 */
	protected BrokerDataSetWriterTransportDataTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TypesPackage.eINSTANCE.getBrokerDataSetWriterTransportDataType();
	}
	...
	public void setQueueName(String newQueueName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__QUEUE_NAME, oldQueueName, queueName, !oldQueueNameESet));
	}
	...
	public void unsetQueueName() {
		...
		queueNameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__QUEUE_NAME, oldQueueName, QUEUE_NAME_EDEFAULT, oldQueueNameESet));
	}
	...
	public void setResourceUri(String newResourceUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__RESOURCE_URI, oldResourceUri, resourceUri, !oldResourceUriESet));
	}
	...
	public void unsetResourceUri() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__RESOURCE_URI, oldResourceUri, RESOURCE_URI_EDEFAULT, oldResourceUriESet));
	}
	...
	public void setAuthenticationProfileUri(String newAuthenticationProfileUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__AUTHENTICATION_PROFILE_URI, oldAuthenticationProfileUri, authenticationProfileUri, !oldAuthenticationProfileUriESet));
	}
	...
	public void unsetAuthenticationProfileUri() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__AUTHENTICATION_PROFILE_URI, oldAuthenticationProfileUri, AUTHENTICATION_PROFILE_URI_EDEFAULT, oldAuthenticationProfileUriESet));
	}
	...
	public void setRequestedDeliveryGuarantee(BrokerTransportQualityOfService newRequestedDeliveryGuarantee) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__REQUESTED_DELIVERY_GUARANTEE, oldRequestedDeliveryGuarantee, requestedDeliveryGuarantee, !oldRequestedDeliveryGuaranteeESet));
	}
	...
	public void unsetRequestedDeliveryGuarantee() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__REQUESTED_DELIVERY_GUARANTEE, oldRequestedDeliveryGuarantee, REQUESTED_DELIVERY_GUARANTEE_EDEFAULT, oldRequestedDeliveryGuaranteeESet));
	}
	...
	public void setMetaDataQueueName(String newMetaDataQueueName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__META_DATA_QUEUE_NAME, oldMetaDataQueueName, metaDataQueueName, !oldMetaDataQueueNameESet));
	}
	...
	public void unsetMetaDataQueueName() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__META_DATA_QUEUE_NAME, oldMetaDataQueueName, META_DATA_QUEUE_NAME_EDEFAULT, oldMetaDataQueueNameESet));
	}
	 ...
	 * @generated
	 */
	public void setMetaDataUpdateTime(double newMetaDataUpdateTime) {
		double oldMetaDataUpdateTime = metaDataUpdateTime;
		metaDataUpdateTime = newMetaDataUpdateTime;
		boolean oldMetaDataUpdateTimeESet = metaDataUpdateTimeESet;
		metaDataUpdateTimeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__META_DATA_UPDATE_TIME, oldMetaDataUpdateTime, metaDataUpdateTime, !oldMetaDataUpdateTimeESet));
	}
	 ...
	 * @generated
	 */
	public void unsetMetaDataUpdateTime() {
		double oldMetaDataUpdateTime = metaDataUpdateTime;
		boolean oldMetaDataUpdateTimeESet = metaDataUpdateTimeESet;
		metaDataUpdateTime = META_DATA_UPDATE_TIME_EDEFAULT;
		metaDataUpdateTimeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__META_DATA_UPDATE_TIME, oldMetaDataUpdateTime, META_DATA_UPDATE_TIME_EDEFAULT, oldMetaDataUpdateTimeESet));
	}
	 ...
	 * @generated
	 */
	public boolean isSetMetaDataUpdateTime() {
		return metaDataUpdateTimeESet;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__META_DATA_QUEUE_NAME:
				...
				return;
			case TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__META_DATA_UPDATE_TIME:
				setMetaDataUpdateTime((Double)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case TypesPackage.BROKER_DATA_SET_WRITER_TRANSPORT_DATA_TYPE__META_DATA_UPDATE_TIME:
				return isSetMetaDataUpdateTime();
		}
	...
	public String toString() {
		...
		result.append(", metaDataUpdateTime: ");
		if (metaDataUpdateTimeESet) result.append(metaDataUpdateTime); else result.append("<unset>");
		result.append(')');
		return result.toString();
	}

} //BrokerDataSetWriterTransportDataTypeImpl
