...
/**
 * This is the item provider adapter for a {@link org.opcfoundation.ua._2011._03.ua.node.set.Reference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SetPackage.Literals.REFERENCE__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addIsForwardPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_isForward_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_isForward_feature", "_UI_Reference_type"),
				 SetPackage.Literals.REFERENCE__IS_FORWARD,
				 true,
				 false,
				 false,
	...
	protected void addReferenceTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reference_referenceType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reference_referenceType_feature", "_UI_Reference_type"),
				 SetPackage.Literals.REFERENCE__REFERENCE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
