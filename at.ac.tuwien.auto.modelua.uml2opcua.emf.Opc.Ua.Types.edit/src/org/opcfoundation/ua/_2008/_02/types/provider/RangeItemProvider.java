...
/**
 * This is the item provider adapter for a {@link org.opcfoundation.ua._2008._02.types.Range} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RangeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Range_low_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Range_low_feature", "_UI_Range_type"),
				 TypesPackage.eINSTANCE.getRange_Low(),
				 true,
				 false,
				 false,
	...
	protected void addHighPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Range_high_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Range_high_feature", "_UI_Range_type"),
				 TypesPackage.eINSTANCE.getRange_High(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Range_type") + " " + range.getLow();
	}
